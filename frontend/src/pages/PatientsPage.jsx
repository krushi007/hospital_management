                    ...
                    <div style={{ display: "flex", gap: 6 }}>
                      ...
                      {p.has_active_appointment ? (
                        ...
                        <button
                          className="btn btn-sm"
                          onClick={() =>
                            navigate(`/appointments?patientId=${p.id}`)
                          }
                          style={{
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  {errors.date_of_birth && (
                    <span className="error-msg">
                      {Array.isArray(errors.date_of_birth)
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <select
                    ...
                    className={errors.blood_group ? "input-error" : ""}
                  >
                  ...
                  {errors.blood_group && (
                    <span className="error-msg">
                      {Array.isArray(errors.blood_group)
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={errors.emergency_contact ? "input-error" : ""}
                  />
                  {errors.emergency_contact && (
                    <span className="error-msg">
                      {Array.isArray(errors.emergency_contact)
          ...
          >
            ...
            <div className="patient-details p-4">
              ...
              >
                <div>
                  <p className="mb-2">
                    <strong>Name:</strong> {viewingPatient.first_name}{" "}
                ...
                <div>
                  ...
                  <p className="mb-2">
                    ...
                    {viewingPatient.height_cm || "—"}
                  </p>
                  <p className="mb-2">
                    <strong>Weight (kg):</strong>{" "}
                    {viewingPatient.weight_kg || "—"}
                  </p>
                  <p className="mb-2">
