                  ...
                  <td>
                    <div style={{ fontSize: "0.82rem" }}>
                      <span style={{ color: "#3b82f6" }}>
                        Pending:{" "}
                        <strong>{doc.pending_appointments || 0}</strong>
                      </span>
                      <br />
                      <span style={{ color: "#eab308" }}>
                        Ongoing:{" "}
                        <strong>{doc.ongoing_appointments || 0}</strong>
                      </span>
                    </div>
                  </td>
                  <td>Rs. {doc.fee}</td>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  {errors.specialization && (
                    <span className="error-msg">
                      {Array.isArray(errors.specialization)
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  {errors.experience_years && (
                    <span className="error-msg">
                      {Array.isArray(errors.experience_years)
                ...
                <div className="form-group">
                  ...
                  {errors.fee && (
                    <span className="error-msg">
                      {Array.isArray(errors.fee) ? errors.fee[0] : errors.fee}
                    </span>
                  )}
                </div>
              </div>
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    required
                    className={errors.license_no ? "input-error" : ""}
                  />
                  {errors.license_no && (
                    <span className="error-msg">
                      {Array.isArray(errors.license_no)
                        ? errors.license_no[0]
                        : errors.license_no}
                    </span>
                  )}
                ...
                <div className="form-group">
                  ...
                  {errors.qualification && (
                    <span className="error-msg">
                      {Array.isArray(errors.qualification)
